...
class BuatCampaign extends StatefulWidget {
  @override
  _BuatCampaignState createState() => _BuatCampaignState();
}

class _BuatCampaignState extends State<BuatCampaign> {
  ...
  Widget build(BuildContext context) {
    List<Step> step = [
    Step(
      title: const Text('Nama Campaign'),
      isActive: true,
        ...
        children: <Widget>[
          ...
          TextFormField(
                    ...
                    validator: (value){
                     ...
                     onSaved: (value){
                       myData.namaCampaign=value;
                     },
                  ),
                  const SizedBox(height: 24.0),
                  TextFormField(
                     onSaved: (value){
                       myData.targetDonasi=value;
                     },
    ...
    Step(
      title: const Text('Info Campaign'),
      isActive: true,
      state: StepState.indexed,
      content: Column(
        children: <Widget>[
